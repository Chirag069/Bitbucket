export const themecolor = '#804d96';
export const themeshade = '#e6e8d2';
export const white = '#ffffff';
export const offWhite = '#F6F6FF';
export const black = '#000';
export const lightGrey = '#939AA4';
export const lighterGrey = '#CDD4DA';
export const angry = '#dd3333';
...
export const headerColor = 'rgb(67, 82, 148)';
export const green = 'green';

//font

export const fontbold = 'ClashDisplay-Semibold';
export const fontregular = 'ClashDisplay-Regular';
